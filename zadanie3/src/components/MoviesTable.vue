...
<template>
  <div class="movies-table-container">
    ...
    <div class="buttons-container">
      <button class="btn btn-light shadow" v-if="!showAll && displayedMovies.length < props.movies.length" @click="showMore"
              :disabled="showAll">
        Show more
      </button>
      <button class="btn btn-light shadow" v-if="displayedMovies.length >= 10" @click="showLess"
